...
- Handling MusicKit limitations and API constraints  
- Maintaining consistent UI state across asynchronous flows  
- Designing scalable content delivery for multiple game modes  
- Balancing performance with real-time reactive updates  

---

## 👨‍💻 About

iOS Developer focused on building scalable, product-oriented mobile applications.
...
- Integration of real-world mobile services  

---

## 📱 LinkedIn Summary

iOS Developer with experience building production mobile applications using Swift.

I focus on creating scalable and maintainable apps with UIKit and SwiftUI, using MVVM + Coordinator architecture, dependency injection, and modern reactive patterns with Combine.

Experienced in integrating Apple Music (MusicKit), Firebase, CloudKit, AdMob, Adapty, Amplitude, and AppsFlyer.

Strong focus on performance optimization, caching strategies, and building clean, product-oriented mobile experiences.

Always open to collaboration and interesting mobile projects.
